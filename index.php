...
$PASSWORD = 'K2020abineT';  // Set the password, to access the file manager... (optional)
...
if($PASSWORD) {
	...
	if(!$_SESSION['_sfm_allowed']) {
		...
		echo '<html><head><title>Raspberry PI 4</title></head><body><h1>Raspberry PI 4 failihaldur</h1><form action=? method=post>PASSWORD:<input type=password name=p autofocus/></form></body></html>';
		exit;
	}
}
...
<!DOCTYPE html>
<html><head>
<title>Raspberry PI 4 - File manager</title>
...
//function startTimer(){
	...
	var interval = setInterval(function() {
	  ...
	  //minutes = (minutes < 10) ?  minutes : minutes;
              ...
              $(".resetcounterzerodiv").hide();
              $(".resetcounterzero").hide();
	  $('.countdown').html('restarting...  ' +minutes + ':' + seconds);
	  if (minutes < 0){ clearInterval(interval); }
	  //check if both minutes and seconds are 0
	  if ((seconds <= 0) && (minutes <= 0)){ 
              clearInterval(interval);
              
              $(".resetcounterzerodiv").show();
              $(".resetcounterzero").show();
              document.location.href = '/filemanager/#pildid_kuvamiseks'
...
<h1>Raspberry PI 4 - failihaldur, pildiesitlus</h1>
<div id="top">
...
<footer>Lihtne filemanager <a href="https://github.com/haamrike/" target="_blank">ha:mrike</a> &copy; 2020</footer>
</body></html>
